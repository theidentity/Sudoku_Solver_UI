...
class Solving_Sudoku(object):
	"""class to store and solve Sudoku"""
	def __init__(self, puzzle_in,show_solving=False):
	...
	def debug(self):
		if self.show_solving:
			numbers = self.serializeBoard(self.board)
...
if __name__ == '__main__':
	s = Solving_Sudoku('003020600900305001001806400008102900700000008006708200002609500800203009005010300')
	s.show_solving = True
	s.solve()
